...
radius = pint.Quantity(6373.0, "kilometer")

# haversine function
## input: p1 and p2: lat1,lon1,lat2,lon2
# performs haversine calculation according to ascribed formulas
## output: d in kilometers, but utilize the pint class to handle distances
def haversine(lat1,lon1, lat2,lon2):
    ...
    d = radius.magnitude * c
    return d #d in kilometers
###
# haversine test suite
